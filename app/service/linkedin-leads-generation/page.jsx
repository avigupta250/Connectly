    ...
    <section>
      <div className="flex justify-center">
        <div className="flex p-10 w-[50%] flex-col gap-6 text-center">
          ...
          LinkedIn Lead Generation That Drives Sales
            </h1>
          <h2 className="text-[20px] md:leading-[25px]">
          We connect you with decision-makers and industry leaders through data-driven LinkedIn outreach. Our proven strategies generate high-quality leads, helping you close more deals effortlessly.
