    ...
    <section>
      <div className="flex justify-center">
        <div className="flex p-10 w-[50%] flex-col gap-6 text-center">
          ...
          Advanced Lead Gen Masterclass for High-ROI Growth
        
          </h1>
          <h2 className="text-[20px] md:leading-[25px]">
          Master cutting-edge lead generation strategies with our expert-led training. Learn AI-driven outreach, precision targeting, and scalable techniques to generate leads effortlessly.
          </h2>
