      ...
      <div className="flex justify-center">
        <div className="flex p-10 w-[50%] flex-col gap-6 text-center">
          <h1 className="text-[50px] md:leading-[60px] font-bold text-blue-600">
            We Run LinkedIn Ads That Actually Convet
          </h1>
          <h2 className="text-[20px] md:leading-[25px]">
            Our Agency get more of your ideal prospects to convert into
            customers through irreristble LinkedIn Ad funnels - 100% done for
            you
          </h2>
