            ...
            <motion.div className="w-1/2 flex">
              <div className="flex flex-col font-serif mt-1 gap-1">
                ...
                <motion.button
                  ...
                  className="bg-[#72589e] text-white text-[25px]  font-serif font-bold px-8 ml-3 py-2 rounded-full mt-5 self-start relative overflow-hidden
...
{/* reviews */}
      ...
      <div className="w-[90%] h-[800px] mt-[100px] rounded-t-3xl mx-auto bg-black bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-[#100b18] via-[#181a45] to-[#171A3F flex flex-col">
        <div className="flex flex-col mt-[40px] items-center gap-6">
          ...
          >
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#c7b6e5]  to-[#7c5eac]">
              Unibox
            </span>
          </motion.h1>
          <motion.p
          ...
          <motion.button
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.5 }}
            className="bg-[#72589e] text-white text-[25px]  font-serif font-bold px-8 ml-3 py-2 rounded-full mt-5 relative overflow-hidden
  shadow-[0_0_15px_4px_rgba(114,88,158,0.5)] hover:shadow-[0_0_25px_6px_rgba(114,88,158,0.8)] transition-shadow duration-300 ease-in-out"
          >
            BOOK A DEMO
          </motion.button>
  ...
  shadow-[0_0_15px_4px_rgba(114,88,158,0.5)] hover:shadow-[0_0_25px_6px_rgba(114,88,158,0.8)] transition-shadow duration-300 ease-in-out"
      ...
      {/* Community */}
      <div className="w-[90%]  mt-[100px] h-[500px] rounded-3xl bg-black flex flex-col md:flex-row gap-5 mx-auto">
        <div className="md:w-3/4 p-10 mt-10  text-white">
          ...
          <motion.button
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.5 }}
            className="bg-[#72589e] text-white md:text-[25px] md:mt-[100px]  font-serif font-bold px-8 ml-3 py-2 rounded-full mt-5 self-start relative overflow-hidden
  shadow-[0_0_15px_4px_rgba(114,88,158,0.5)] hover:shadow-[0_0_25px_6px_rgba(114,88,158,0.8)] transition-shadow duration-300 ease-in-out"
          >
            START FOR FREE
          </motion.button>
